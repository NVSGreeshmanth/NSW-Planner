...
class H(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # ── Trip Planner API ──
            ...
            # Optional time offset for past trips (offset=45 means 45 mins ago)
            offset = int(qs.get("offset", "0"))
            if offset > 0:
                t_offset = datetime.datetime.now() - datetime.timedelta(minutes=offset)
        ...
        # ── Departure API ──
            ...
            import datetime
            # Offset time to include past trains (default 45 min back)
